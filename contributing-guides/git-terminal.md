...
1. Fork the khulnasoft-lab/cheatlist repository on the GitHub web interface.
...
[mass-changes]: https://github.com/khulnasoft-lab/cheatlist/pulls?&q=is:pr+is:merged+label:"mass+changes"
...
```bash
git checkout main
git remote add upstream https://github.com/khulnasoft-lab/cheatlist.git  # only run if you don't already have the upstream remote (check with "git remote -v")
