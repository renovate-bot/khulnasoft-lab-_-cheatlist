...
[`tldr tldr-lint`](https://github.com/khulnasoft-lab/cheatlist/blob/main/pages/common/tldr-lint.md). Alternatively, you can also use its alias `tldrl`.
...
- Pre-translated alias page templates can be found [here](https://github.com/khulnasoft-lab/cheatlist/blob/main/contributing-guides/translation-templates/alias-pages.md).
...
**2. Provides a new alias but only executable in PowerShell**, such as `ni` for `New-Item`. In this case, use the [standard alias template](https://github.com/khulnasoft-lab/cheatlist/blob/main/contributing-guides/translation-templates/alias-pages.md), but add the word "In Powershell," (or equivalent) to indicate that the command is exclusive to PowerShell. For example,
...
If you are afraid the commands may differ between platforms or operating systems (e.g. Windows vs macOS), most [tldr pages clients](https://github.com/khulnasoft-lab/cheatlist/wiki/tldr-pages-clients) will choose the most suitable version of the command.
