...
- **Regular contributors should be added as collaborators in the repository.**
  ...
  (see `https://github.com/khulnasoft-lab/cheatlist/commits?author=<username>`)
...
- **Repository collaborators who regularly perform maintenance tasks should be added as organization members.**
  ...
  (see `https://github.com/khulnasoft-lab/cheatlist/commits?committer=<username>`)
  and submitted at least _5 non-trivial reviews to PRs_
  (see `https://github.com/khulnasoft-lab/cheatlist/pulls?q=reviewed-by:<username>`),
...
1. Open an issue with the following message template (edit it as appropriate):
   ...
   That qualifies you to become a collaborator in this repository, as explained in our [community roles documentation](https://github.com/khulnasoft-lab/cheatlist/blob/main/COMMUNITY-ROLES.md).
   ...
   If you do decide to start performing maintenance tasks, though, we only ask you to get familiar with the [maintainer's guide](https://github.com/khulnasoft-lab/cheatlist/blob/main/contributing-guides/maintainers-guide.md).
...
2. Once they acknowledge the message, and if they accept the invitation,
   go to https://github.com/khulnasoft-lab/cheatlist/settings/collaboration
...
1. Open an issue with the following message template (edit it as appropriate):
   ...
   Thank you for that!
   According to our [community roles documentation](https://github.com/khulnasoft-lab/cheatlist/blob/main/COMMUNITY-ROLES.md), you've now met the thresholds to be effectively considered an active maintainer of the project.
   ...
   governance principles](https://github.com/khulnasoft-lab/cheatlist/blob/main/GOVERNANCE.md).
...
1. Open an issue with the following message template (edit it as appropriate):
   ...
   According to our [community roles documentation](https://github.com/khulnasoft-lab/cheatlist/blob/main/COMMUNITY-ROLES.md), you're now eligible for becoming an owner in the organization.
   ...
   When performing such role transitions, make sure to follow the process described in the [COMMUNITY-ROLES.md](https://github.com/khulnasoft-lab/cheatlist/blob/main/COMMUNITY-ROLES.md) document.
...
1. Open an issue with the following message template (edit it as appropriate):
   ...
   ```
   Hi, @username! As you know, our [community roles documentation](https://github.com/khulnasoft-lab/cheatlist/blob/main/COMMUNITY-ROLES.md) defines processes for keeping the list of organization members in sync with the actual maintenance team.
...
The [`.github/CODEOWNERS` file](https://github.com/khulnasoft-lab/cheatlist/blob/main/.github/CODEOWNERS) allows contributors with write access to the [khulnasoft-lab/cheatlist repository](https://github.com/khulnasoft-lab/cheatlist) to get automatic review request notifications for given files and directories.
...
- Contributors interested in reviewing [client specification](https://github.com/khulnasoft-lab/cheatlist/blob/main/CLIENT-SPECIFICATION.md) updates.

> [!NOTE]
> This mechanism is purely for automatic review requests for PRs and doesn't grant collaborators additional copyright over the code-owned files. View the [LICENSE](https://github.com/khulnasoft-lab/cheatlist/blob/main/LICENSE.md) file for more information.
