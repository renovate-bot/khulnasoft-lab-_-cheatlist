...
If a page cannot be found in _any_ platform, then it is RECOMMENDED that clients display an error message with a link to create a new issue against the `khulnasoft-lab/cheatlist` GitHub repository. Said link might take the following form:

```url
https://github.com/khulnasoft-lab/cheatlist/issues/new?title=page%20request:%20{command_name}
```
...
Regardless of the language determined through the environment, clients MUST always attempt to fall back to English if the page does not exist in the user's preferred language. Clients MAY notify the user when a page in their preferred language cannot be found (optionally including a link to the [translations section of the contributing guide](https://github.com/khulnasoft-lab/cheatlist/blob/main/CONTRIBUTING.md#translations)).
...
If appropriate, it is RECOMMENDED that clients implement a cache of pages. If implemented, clients MUST download the entire archive either as a whole from **[https://khulnasoft-lab.github.io/cheatlist/assets/tldr.zip](https://khulnasoft-lab.github.io/cheatlist/assets/tldr.zip)** (Which redirects to [https://raw.githubusercontent.com/khulnasoft-lab/cheatlist-pages.github.io/main/assets/tldr.zip](https://raw.githubusercontent.com/khulnasoft-lab/cheatlist-pages.github.io/main/assets/tldr.zip)) or download language-specific translation archives in the format `https://khulnasoft-lab.github.io/cheatlist/assets/tldr-pages.{{language-code}}.zip` (Which redirects to [https://raw.githubusercontent.com/khulnasoft-lab/cheatlist-pages.github.io/main/assets/tldr-pages.{{language-code}}.zip](https://raw.githubusercontent.com/khulnasoft-lab/cheatlist-pages.github.io/main/assets)), along with the archive for English from **[https://khulnasoft-lab.github.io/cheatlist/assets/tldr-pages.zip](https://khulnasoft-lab.github.io/cheatlist/assets/tldr-pages.zip)** (It redirects to [https://raw.githubusercontent.com/khulnasoft-lab/cheatlist-pages.github.io/main/assets/tldr-pages.zip](https://raw.githubusercontent.com/khulnasoft-lab/cheatlist-pages.github.io/main/assets/tldr-pages.zip)).
...
create a new release under https://github.com/khulnasoft-lab/cheatlist/releases
...
- [v2.1, November 30th 2023](https://github.com/khulnasoft-lab/cheatlist/blob/v2.1/CLIENT-SPECIFICATION.md) ([#11523](https://github.com/khulnasoft-lab/cheatlist/pull/11523))
  - Add requirement to support escaping the placeholder syntax in certain pages ([#10730](https://github.com/khulnasoft-lab/cheatlist/pull/10730))
  - Add suggestion to detect new platforms added to the relevant `pages` directory automatically ([#11523](https://github.com/khulnasoft-lab/cheatlist/pull/11523))

- [v2.0, September 10th 2023](https://github.com/khulnasoft-lab/cheatlist/blob/v2.0/CLIENT-SPECIFICATION.md) ([#10148](https://github.com/khulnasoft-lab/cheatlist/pull/10148))
  - Add recommendation to support `macos` alias for `osx` ([#7514](https://github.com/khulnasoft-lab/cheatlist/pull/7514))
  - Drop the special "all" platform from the `--list` flag ([#7561](https://github.com/khulnasoft-lab/cheatlist/pull/7561))
  - Drop the `master` branch from the assets link. ([#9668](https://github.com/khulnasoft-lab/cheatlist/pull/9668))
  - Require support for long options ([#9651](https://github.com/khulnasoft-lab/cheatlist/pull/9651))
  - Add recommendation to support caching individual translation archives ([#10148](https://github.com/khulnasoft-lab/cheatlist/pull/10148))

- [v1.5, March 17th 2021](https://github.com/khulnasoft-lab/cheatlist/blob/v1.5/CLIENT-SPECIFICATION.md) ([#5428](https://github.com/khulnasoft-lab/cheatlist/pull/5428))
...
- [v1.4, August 13th 2020](https://github.com/khulnasoft-lab/cheatlist/blob/v1.4/CLIENT-SPECIFICATION.md) ([#4246](https://github.com/khulnasoft-lab/cheatlist/pull/4246))
  - Add requirement for CLI clients to use non-zero exit code on failing to find a page.

- [v1.3, June 11th 2020](https://github.com/khulnasoft-lab/cheatlist/blob/v1.3/CLIENT-SPECIFICATION.md) ([#4101](https://github.com/khulnasoft-lab/cheatlist/pull/4101))
...
- [v1.2, July 3rd 2019](https://github.com/khulnasoft-lab/cheatlist/blob/v1.2/CLIENT-SPECIFICATION.md) ([#3168](https://github.com/khulnasoft-lab/cheatlist/pull/3168))
...
- [v1.1, April 1st 2019](https://github.com/khulnasoft-lab/cheatlist/blob/v1.1/CLIENT-SPECIFICATION.md) (deprecated) ([#2859](https://github.com/khulnasoft-lab/cheatlist/pull/2859))
  - Clarified platform section.

- [v1.0, January 23rd 2019](https://github.com/khulnasoft-lab/cheatlist/blob/v1.0/CLIENT-SPECIFICATION.md) (deprecated) ([#2706](https://github.com/khulnasoft-lab/cheatlist/pull/2706))
  - Initial release.
