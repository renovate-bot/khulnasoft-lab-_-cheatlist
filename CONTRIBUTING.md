...
[contributors-image]: https://img.shields.io/github/contributors/khulnasoft-lab/cheatlist.svg?label=Contributors
[cla-assistant-url]: https://cla-assistant.io/khulnasoft-lab/cheatlist
[cla-assistant-image]: https://cla-assistant.io/readme/badge/khulnasoft-lab/cheatlist
...
To get started, please [sign](https://cla-assistant.io/khulnasoft-lab/cheatlist) the
...
> [!NOTE]
> While we suggest only two lines for the page description, it is acceptable to have more than two lines if it necessary to add additional information (i.e. [`pacman`](https://github.com/khulnasoft-lab/cheatlist/blob/main/pages/linux/pacman.md)).

To see some examples of preexisting pages, you can look at:

- [pwd](https://github.com/khulnasoft-lab/cheatlist/blob/main/pages/common/pwd.md) - one of the simplest command examples
- [tar](https://github.com/khulnasoft-lab/cheatlist/blob/main/pages/common/tar.md) - page with placeholders
...
Once you have written a `tldr` page, you can test its syntax locally using [`tldr-lint`](https://github.com/khulnasoft-lab/cheatlist-lint).
...
[Contributor License Agreement](https://cla-assistant.io/khulnasoft-lab/cheatlist).
