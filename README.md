<div align="center">
  <h1><a href="https://khulnasoft-lab.github.io/cheatlist/"><img alt="tldr-pages" src="images/banner.png" width=600/></a></h1>
...
[github-actions-url]: https://github.com/khulnasoft-lab/cheatlist/actions
[github-actions-image]: https://img.shields.io/github/actions/workflow/status/khulnasoft-lab/cheatlist/ci.yml?branch=main&label=Build
[matrix-url]: https://matrix.to/#/#tldr-pages:matrix.org
[matrix-image]: https://img.shields.io/matrix/tldr-pages:matrix.org?label=Chat+on+Matrix
[prs-merged-url]: https://github.com/khulnasoft-lab/cheatlist/pulls?q=is:pr+is:merged
[prs-merged-image]: https://img.shields.io/github/issues-pr-closed-raw/khulnasoft-lab/cheatlist.svg?label=Merged+PRs&color=green
[contributors-url]: https://github.com/khulnasoft-lab/cheatlist/graphs/contributors
[contributors-image]: https://img.shields.io/github/contributors-anon/khulnasoft-lab/cheatlist.svg?label=Contributors
[license-url]: https://github.com/khulnasoft-lab/cheatlist/blob/main/LICENSE.md
...
is to install the [Node.js client](https://github.com/khulnasoft-lab/cheatlist-node-client),
...
Alternatively, you can also use the official [Python client](https://github.com/khulnasoft-lab/cheatlist-python-client), which can be installed via [pip3](https://pypi.org/project/tldr/).
...
check out the [PDF version](https://khulnasoft-lab.github.io/cheatlist/assets/tldr-book.pdf).
...
For a comprehensive list of clients, head over to our [Wiki](https://github.com/khulnasoft-lab/cheatlist/wiki/tldr-pages-clients).
...
- Adding requested pages from our issues with the [help wanted](https://github.com/khulnasoft-lab/cheatlist/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22) label.
