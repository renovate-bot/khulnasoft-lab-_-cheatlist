...
def main(loc, colorscheme, output_filename, platform):
    ...
    html = (
        ...
        + "</small></em></div><br><br>"
        + "<div class=title-sub>Website: <a href=https://khulnasoft-lab.github.io/cheatlist>https://khulnasoft-lab.github.io/cheatlist</a></div><br>"
        + "<div class=title-sub>GitHub: <a href=https://github.com/khulnasoft-lab/cheatlist>https://github.com/khulnasoft-lab/cheatlist</a></div><br>"
